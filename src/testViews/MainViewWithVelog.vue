...
const posts = [
  {
    title: 'Velog 스타일 카드dddddddddddddddddddddqs',
    summary: 'Vue + Vuetify로 만드는 블로그 메인 카드dddddddddddddddddddddddddddddd',
    thumbnail: 'https://about.canva.com/wp-content/uploads/sites/8/2019/03/red.png',
    avatar: 'https://i.pravatar.cc/40?img=1',
    author: 'taehyeonddddddddddddddddddddddddddddddddddddddddddsssssssss',
    date: '3일 전',
  },
  {
    title: 'Velog 스타일 카드',
    summary: 'Vue + Vuetify로 만드는 블로그 메인 카드',
    thumbnail:
...
<template>
  <SidebarLayout>
    <v-container fluid>
      <v-row>
        <v-col v-for="(post, index) in posts" :key="index" md="3">
          <v-card hover>
            <v-img :src="post.thumbnail" height="225px" cover />
            ...
            <v-card-actions>
              <v-avatar :image="post.avatar" size="x-small" text="test" />
              <span class="text-caption"> {{ post.author }} · {{ post.date }} </span>
            </v-card-actions>
          </v-card>
        </v-col>
      </v-row>
